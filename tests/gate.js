...
// fires on them, and returns to green once one is answered. The anchor is the
...
gate.section('instrument/documentation coupling (spec 025 A-025-14, in force from the 026 merge)');
{
  const { docsLag } = require('./instrument-coupling');
  const IN_FORCE_FROM = 'd19a195dfcce183265084bbf16537315904afaaf';
