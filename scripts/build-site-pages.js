...
const TYPE_NOTES = {
  ...
  'Instrument comparison report': ['overlapping',
    'Holds the skills and their inputs still and measures them with two instruments, reporting what each can and cannot establish.'],
};
...
<h2>The ${word(TYPES.length)} report types</h2>
<p>Driftproof publishes ${word(TYPES.length)} kinds of report. All ${word(TYPES.length)} read Driftproof's own arms by the same rule, and they differ in what moves underneath the skill, in the value report in which axes are measured, and in the instrument comparison in which instrument does the measuring.</p>
${cards}
</section>
</main>`;
  return shell({
...
module.exports = { shell, heroReceipt, reportCard, HOME_CARD_STAT, statePlot, plotState, subscribedPage, reportTypes, typeNote, word, bandFacts, bandsSection, floorFigure, checksSchemaVersion, tokensSchemaVersion, patchMethodology, PATCHES, homepage, reportsIndex, glossaryPage, reportTypesPage, notFoundPage, redirectStub, STUBS, TERMS, TARGETS, reader, stats, reports, buildCards };
