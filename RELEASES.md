...
- **Spec 028's NFR-7 reads red until this publish**, because `package.json` is not what
  `driftproof@0.11.1` publishes (the ajv floor). It is re-run after the publish, never before
  (BACKLOG § 2 step 3).
